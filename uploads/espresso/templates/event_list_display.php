...
<div id="event_data-<?php echo $first_event_instance['event_id']?>" class="event_data subpage_excerpt r">
	...
	<?php if (count($events_group) > 1) :
        ...
        <div class="date_picker" id="date_picker_<?php echo $first_event_instance['event_id']?>">
            ...
            <h6 style="margin-top:20px; top:-4px"><?php _e('Available Dates', 'event_espresso'); ?></h6>
            ...
            <ul>
        	    ...
        	    <?php foreach ($events_group as $e) :
                    ...
                    if ($num_attendees >= $e['reg_limit']) : 
                        ...
                        echo ' Sold Out</span> <a href="'.get_option('siteurl').'/?page_id='.$e['event_page_id'].'&regevent_action=register&event_id='.$e['overflow_event_id'].'&name_of_event='.stripslashes_deep($e['event_name']).'">'.__('(Join Waiting List)').'</a>';
