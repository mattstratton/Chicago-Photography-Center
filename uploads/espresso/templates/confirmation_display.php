...
?>
	...
	<p><h3>Registration policy</h3>
We reserve the right to cancel any class due to insufficient attendance. Registration is preferred online, but may be handled over the phone, or in  person at CPC during office hours. Fees must be paid in full and in advance. Refunds are not available. If a class is canceled for any reason, we will offer a credit for another session or class. We do not provide refunds for students who wish to withdraw from a class. We are a non-profit organization and we depend on your support.
