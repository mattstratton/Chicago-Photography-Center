...
<div class = "event_espresso_form_wrapper">
    ...
    <p><strong><?php _e('Credit Card Information', 'event_espresso'); ?></strong><br />(Visa, MasterCard, American Express, Discover, Diners Club, JCB)</p>
    <p>
        <label for="card_num"><?php _e('Card Number', 'event_espresso'); ?></label>
        <input type="text" name="card_num" id="card_num" />
    </p>
    <p>
        <label for="exp_date"><?php _e('Exp. Date (MM/YY)', 'event_espresso'); ?></label>
