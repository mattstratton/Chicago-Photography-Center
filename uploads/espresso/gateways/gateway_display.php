...
if (
				get_option('events_paypal_active') == 'true'
...
echo '</div><!-- / .event-data-display -->';
		?>
		Chicago Photography Center takes <a href = "/security" target = "_new">security seriously</a>!
		<div class="AuthorizeNetSeal"><script type="text/javascript" language="javascript">// <![CDATA[
var ANS_customer_id="152a2a44-d15a-4ec3-885f-cbfbb0a819ae";
// ]]></script><script type="text/javascript" language="javascript" src="//verify.authorize.net/anetseal/seal.js"></script><a id="AuthorizeNetText" href="http://www.authorize.net/" target="_blank">Accept Credit Cards</a></div>
				<?php
